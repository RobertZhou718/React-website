        ...
        <div class="container">
          ...
          <div class="mt-5 col-md">
            <table class="table">
              <h3>
                <u>
                  <Trans>Materials required for Business tax</Trans>
                </u>
              </h3>
              <thead>
                <tr>
              ...
              <div class="card border-secondary bg-light text-dark">
                ...
                <div class="card-body text-center">
                  <div class="card-title ">
                    <h4>
                      <Trans>Business Registration</Trans>
                    </h4>
                  </div>
                  <div class="card-text">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="card bg-light border-secondary text-dark">
                ...
                <div class="card-body text-center">
                  <div class="card-title">
                    <h4>
                      <Trans>Financial Statement</Trans>
                    </h4>
                  </div>
                  <div class="card-text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md">
              ...
              <p class="my-4 lead">
                ...
                quas accusamus, ex voluptatibus ea? Atque veniam ratione,
              </p>
