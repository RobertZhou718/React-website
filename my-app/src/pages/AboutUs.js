    ...
    <div className="container">
      <div className="row align-items-center justify-content-between">
        <div className="col-md">
          <h1>About Us</h1>
          <p className="mt-5 lead">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem assumenda reprehenderit debitis optio excepturi tenetur provident non repellat quis culpa odit similique, nulla in, sunt laborum accusantium unde corrupti. Quaerat?
        ...
        <div className="col-md">
          <img src="img/biglogo.png" alt="logo" className="img-fluid d-none d-md-block"/>
        </div>
      </div>
    </div>
</section>
<section className="p-5 bg-dark">
    <div className="container">
      <div id="section1" className="text-light">
        <h1 className="text-center">COVID-19 Related Tax Assistance</h1>
        <h3 className="mt-5">Lorem ipsum dolor</h3>
        <p className="lead mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit.
