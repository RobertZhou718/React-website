...
const Taxform = ({ user }) => {
    const { taxFormHead, invalid, holder, starValue, options, formHead } = getConfig();
                ...
                <div className="container">
                    ...
                    <form className="form-horizontal" >
                        <div className="container-fluid">
                            <div className="row">
                                {taxFormHead.map((head => <InputForm
                                    formType={"col-md-4"}
                                    key={head}
                                    name={head}
...
function getConfig() {
    ...
    const taxFormHead = ["First name", "Last name", "Date of Birth", "SIN#", "Email", "Phone", "Mailing Address", "City", "Province", "Zip", "Marital Status", "First time tax filling in CA?", "Are you a Canadian Citizen", "Existing client"];
    const starValue = {
        "First name": "*",
        "Last name": "*",
        "Date of Birth": "*",
    ...
    const province = ["Alberta", "British Columbia", "Manitoba", "New Brunswick", "Newfoundland and Labrador", "Nova Scotia", "Nunavut", "Ontario", "Prince Edward Island", "Quebec", "Saskatchewan", "Yukon"];
    const marital = ["Single", "Married", "Living common law", "Separated", "Divorced", "Widowed"];
