...
const FileInput =(props)=>{
  ...
  <input name = {props.name}className="form-control" onChange={props.handleChange}  type="file" />
  </div>)
}
  ...
  return (
    ...
    <form action="#" className="form-horizontal" >
      <div className="container">
        ...
        </h3>{fileList.map((fileindex)=>
        <FileInput key={fileindex} name ={fileindex} handleChange={handleChange} />)}
      </div>
    </form>
    <form action="#" className="form-horizontal" >
        <div className="container">
        ...
        <div className="col-md-12" align ="center">
          <button className="btn btn-primary" type="file" disabled={Object.values(files).every(value => {
                                    if (value === null) {
                                        return true;
                                    }
                                    return false;
