            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item drop_down ">
                      <Link className="nav-link text-dark drop_btn" to="/">Home</Link></li>
                    <li className="nav-item drop_down">
                        <Link className="nav-link text-dark drop_btn" to="Personal" id="navbarDarkDropdownMenuLink" role="button"  aria-expanded="false">
                        Personal Tax
                        </Link>
                    ...
                    <li className="nav-item  drop_down ">
                        <Link className="nav-link text-dark drop_btn" to="Business" id="navbarDarkDropdownMenuLink" role="button"  aria-expanded="false">
                        Business Tax
                        </Link>
                        <ul className="dropdown-menu drop_down-content" aria-labelledby="navbarDarkDropdownMenuLink">
                    ...
                    <li className="nav-item drop_down ">
                      <Link className="nav-link text-dark drop_btn" to="Housing">Housing Related Tax</Link></li>
                    <li className="nav-item drop_down">
                        <Link className="nav-link text-dark drop_btn" to="AboutUs" id="navbarDarkDropdownMenuLink" role="button" aria-expanded="false">
                        About Us
                        </Link>
                        <ul className="dropdown-menu  drop_down-content" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><Link className="dropdown-item" to="#section1">COVID-19 Related Tax Assistance</Link></li>
                            
                        </ul>
                    </li>
                    <li className="nav-item drop_down ">
                        <Link className="nav-link text-dark drop_btn" to="ContactUs" id="navbarDarkDropdownMenuLink" aria-expanded="false">
                        Contact Us
                        </Link>
                        <ul className="dropdown-menu  drop_down-content" aria-labelledby="navbarDarkDropdownMenuLink">
                    ...
                    <li className="nav-item drop_down bg-warning">
                      <Link className="nav-link text-dark drop_btn" to="TaxOnline">Tax online</Link></li>
                      <li className="nav-item drop_down float-end">
                        <span className="nav-link text-dark drop_btn" role="button" aria-expanded="false">lang</span>
